 ...
 * name (in the database). That said, you don't have to specify the table
 * name because Hibernate will use the model's name as the table name if no
 * name is specified here.
 */
@Table(name = "card_table", schema="schema1")
public class Card {

	/*
	 * The @Id annotation denotes that we wish to use this field as a primary
	 * key on this table.
	 */
	@Id
	/*
